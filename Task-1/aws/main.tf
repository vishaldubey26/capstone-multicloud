...
resource "aws_instance" "app_machine" {
  ...
  tags = { Name = "capstone-app-machine" }
}
...
resource "aws_instance" "tools_machine" {
  ...
  vpc_security_group_ids = [aws_security_group.app_sg.id]
  key_name               = aws_key_pair.capstone.key_name
  tags = { Name = "capstone-tools-machine" }
}

output "app_machine_ip" {
  value = aws_instance.app_machine.public_ip
}

output "tools_machine_ip" {
